	 ...
	 var methods = {
		...
		*/
		validate: function() {
			...
			if(element.is("form") && !element.hasClass('validating')) {
				...
				var options = (form.data('jqv')) ? form.data('jqv') : jQuery.validationEngine.defaults;  
		...
		*/
		 ...
		 */
		 hideAll: function() {
			 ...
			 jQuery('.formError').fadeTo(duration, 0.3, function() {
				 jQuery(this).parent('.formErrorOuter').remove();
				 jQuery(this).remove();
			 });
			 return this;
		...
		*/
		_handleStatusCssClasses: function(field, options) {
		 ...
		 _getErrorMessage:function (form, field, rule, rules, i, options, originalValidationMethod) {
			 ...
			 if (errorMsg != undefined) {
				 var custom_message = methods._getCustomErrorMessage(jQuery(field), element_classes_array, beforeChangeRule, options);
		...
		_required: function(field, rules, i, options, condRequired) {
			switch (field.prop("type")) {
				...
				default:
					...
					if (! jQuery.trim(field.val()) || field.val() == field.attr("data-validation-placeholder") || field.val() == field.attr("placeholder"))
		...
		*/
		_getPrompt: function(field) {
				var formId = jQuery(field).closest('form').attr('id');
